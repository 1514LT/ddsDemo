...
constexpr uint32_t RestartInfo_max_cdr_typesize {6UL};
constexpr uint32_t RestartInfo_max_key_cdr_typesize {0UL};

constexpr uint32_t ReplyInfo_max_cdr_typesize {5UL};
