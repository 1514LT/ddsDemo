...
SlaveNodeCPubListener::SlaveNodeCPubListener()
:m_matched(0)
{
}
...
void SlaveNodeCPubListener::on_publication_matched(DataWriter * dataWriter, const PublicationMatchedStatus & info)
{
...
SlaveNodeCPublisher::SlaveNodeCPublisher()
...
bool SlaveNodeCPublisher::initPubType(const std::string & topicName, const std::string & typeName, TopicDataType * dataType, DataWriterListener * listener)
{
